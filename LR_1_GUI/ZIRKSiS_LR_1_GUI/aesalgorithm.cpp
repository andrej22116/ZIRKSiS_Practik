...
std::string AESAlgorithm::encrypt(std::string string)
{
...
std::string AESAlgorithm::decrypt(std::string string)
{
...
bool AESAlgorithm::encryptSmallFile(std::string pathInput, std::string pathOutput)
{
...
bool AESAlgorithm::decryptSmallFile(std::string pathInput, std::string pathOutput)
{
    std::ifstream fin(pathInput);
    std::ofstream fout(pathOutput);
